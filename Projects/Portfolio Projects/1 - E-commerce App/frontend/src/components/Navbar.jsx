    ...
    return (
        <div className="flex items-center justify-between py-5 font-medium">
            ...
            <div className="flex items-center gap-6">
                <img src={f_assets.search_icon} onClick={() => setShowSearch(true)} className="w-5 cursor-pointer" alt="" />
                ...
                <Link to="/cart" className="relative">
                    ...
                    <p className="absolute right-[-8px] bottom-[7px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[10px]">{getCartCount()}</p>
                </Link>
